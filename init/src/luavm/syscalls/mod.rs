...
#![allow(dead_code, reason = "TODO(2026-09-12): shared auth/syscalls/term module compiled per onyx_init bin; per-bin unused items are live in other bins")]
#![allow(unused_imports, reason = "TODO(2026-09-12): same shared-module per-bin import set")]
pub mod call;
pub mod consts;
